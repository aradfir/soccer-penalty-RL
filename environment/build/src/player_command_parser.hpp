...
#ifndef YY_YY_HOME_ARAD_ROBO_RCSSSERVER_18_1_3_BUILD_SRC_PLAYER_COMMAND_PARSER_HPP_INCLUDED
# define YY_YY_HOME_ARAD_ROBO_RCSSSERVER_18_1_3_BUILD_SRC_PLAYER_COMMAND_PARSER_HPP_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    RCSS_PCOM_VIEW_WIDTH_NARROW = 285, /* "narrow"  */
    RCSS_PCOM_VIEW_WIDTH_NORMAL = 286, /* "normal"  */
    RCSS_PCOM_VIEW_WIDTH_WIDE = 287, /* "wide"  */
    RCSS_PCOM_VIEW_QUALITY_LOW = 288, /* "low"  */
    RCSS_PCOM_VIEW_QUALITY_HIGH = 289, /* "high"  */
    RCSS_PCOM_ON = 290,            /* "on"  */
    RCSS_PCOM_OFF = 291,           /* "off"  */
    RCSS_PCOM_TRUE = 292,          /* "true"  */
    RCSS_PCOM_FALSE = 293,         /* "false"  */
    RCSS_PCOM_OUR = 294,           /* "our"  */
    RCSS_PCOM_OPP = 295,           /* "opp"  */
    RCSS_PCOM_LEFT = 296,          /* RCSS_PCOM_LEFT  */
    RCSS_PCOM_RIGHT = 297,         /* RCSS_PCOM_RIGHT  */
    RCSS_PCOM_EAR_PARTIAL = 298,   /* "partial"  */
    RCSS_PCOM_EAR_COMPLETE = 299,  /* "complete"  */
    RCSS_PCOM_CLANG_VERSION = 300, /* "ver"  */
    RCSS_PCOM_ERROR = 301          /* RCSS_PCOM_ERROR  */
  };
...
#endif /* !YY_YY_HOME_ARAD_ROBO_RCSSSERVER_18_1_3_BUILD_SRC_PLAYER_COMMAND_PARSER_HPP_INCLUDED  */
